        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
          <div className="space-y-8">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 dynamic-bg rounded-xl flex items-center justify-center font-black text-white">
            ...
            <p className="text-slate-500 leading-relaxed font-light text-sm italic">
              {lang === 'ar' ? `شركة ${settings.brandName.ar} هي المصدر الرائد للفحم النباتي.` : `${settings.brandName.en} is the leading charcoal exporter.`}
            </p>
          </div>
          ...
          <div className="lg:col-span-2 flex flex-col items-center lg:items-end justify-center">
            <div className="bg-white p-10 rounded-[3rem] border border-slate-100 w-full text-center shadow-premium">
               ...
               <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <a href={`tel:${settings.phone}`} className="px-10 py-4 dynamic-bg text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-dynamic">Call Now</a>
               </div>
            </div>
          </div>
        </div>
